        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="5" placeholder="Masukkan Deskripsi Product">{{ old('description', $data['product']->description) }}</textarea>
